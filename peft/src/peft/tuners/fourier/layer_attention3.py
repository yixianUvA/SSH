...
class FourierLayer(BaseTunerLayer):
    ...
    def apply_attention_weights(self, adapter_name, attention_scores):
        ...
        attention_weights = attention_weights.view(1, 1, -1).expand(attention_scores.size(0), attention_scores.size(1), -1)
    ...
    def forward(self, x: torch.Tensor, *args: Any, **kwargs: Any) -> torch.Tensor:
        ...
        if self.disable_adapters:
            ...
            for active_adapter in self.active_adapters:
                ...
                # Compute adaptation (maintaining batch dimension)
                adaptation = torch.einsum('bsi,ij->bsj', x, delta_w)
